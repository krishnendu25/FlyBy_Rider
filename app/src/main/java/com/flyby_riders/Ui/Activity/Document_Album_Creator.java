...
public class Document_Album_Creator extends BaseActivity implements onClick {
    ...
    private void uploadMultiFile() {
        ...
        builder.addFormDataPart("userid", new Session(this).get_LOGIN_USER_ID());
    ...
    private void Get_Api_Photo_Process(ArrayList<String> photo_link) {
        ...
        for (int j=0;j<photo_link.size();j++)
        {
            ...
            file_name.add(Constant.SaveImagetoSDcard(Constant.get_random_String(),
                    Constant.get_random_String(),v,Document_Album_Creator.this));
        }
