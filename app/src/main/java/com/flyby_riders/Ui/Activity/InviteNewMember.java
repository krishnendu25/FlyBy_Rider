...
public class InviteNewMember extends BaseActivity implements onClick {
    ...
    class TestAsync extends AsyncTask<Void, Integer, String> {
        ...
        protected String doInBackground(Void... arg0) {
                ...
                local_contact.clear();
                local_contact = getContactsForm_Phone(InviteNewMember.this);
                Filter_Contact();
        ...
        protected void onPostExecute(String result) {
            ...
            contact_adapter = new Contact_Adapter(InviteNewMember.this, local_contact);
            NotFlybyUser.setAdapter(contact_adapter);
            flyBy_contact_adapter = new FlyBy_Contact_Adapter(InviteNewMember.this, FlyBy_local_contact);
    ...
    {
        if (new Prefe(getApplicationContext()).getAllContact().size()>0) {
            local_contact = new Prefe(getApplicationContext()).getAllContact();
            FlyBy_local_contact = new Prefe(getApplicationContext()).getFlybyContact();
            contact_adapter = new Contact_Adapter(InviteNewMember.this, local_contact);
            NotFlybyUser.setAdapter(contact_adapter);
            flyBy_contact_adapter = new FlyBy_Contact_Adapter(InviteNewMember.this, FlyBy_local_contact);
            FlybyUser.setAdapter(flyBy_contact_adapter);
