...
public class Document_Locker extends BaseActivity implements onClick {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.Add_Document_btn:
                Intent i = new Intent(this, Document_Album_Creator.class);
    ...
    private void hit_get_my_album(String select_my_bike_id) {
        show_ProgressDialog();
        Call<ResponseBody> requestCall = retrofitCallback.Fetch_Album(new Session(this).get_LOGIN_USER_ID(),
                select_my_bike_id);
                        ...
                        if (jsonObject.getString("success").equalsIgnoreCase("1")) {
                            ...
                            if (Album_Content_list.size()>0)
                            {
                                Collections.reverse(Album_Content_list);
                                 mb = new My_Album_View(Album_Content_list,Document_Locker.this);
                        ...
                        if (jsonObject.getString("success").equalsIgnoreCase("1")) {
                            ...
                            if (BIKEBRANDDETAILS!=null)
                            {
                                ...
                                {My_Bike_els.clear();
                                    ...
                                    if (My_Bike_els.size()>0)
                                    {
                                        My_Bike_Adapter b = new My_Bike_Adapter(My_Bike_els,Document_Locker.this);
